...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/actualizarPedido.css">
</head>
		...
		<main class="contenido_principal_actualizar">
			<div class="panel_actualizacion">
				<div class="header_actualizacion">
					<h2>
						<i class="fas fa-edit"></i> Actualizar Pedido #${pedido.idPedido}
					</h2>
				...
				<form id="formActualizarPedido" action="GestionarPedido"
					method="post">
					<input type="hidden" name="ruta" value="aceptarCambios"> <input
						type="hidden" name="idPedido" value="${pedido.idPedido}">
					...
					<div class="seccion_formulario">
						...
						<div class="form_grid">
							<div class="form_grupo">
								<label for="numMesa"> <i class="fas fa-table"></i>
									Número de Mesa:
								</label> <input type="number" id="numMesa" name="numMesa"
									value="${pedido.numMesa}" required min="1" max="50">
							</div>

							<div class="form_grupo">
								<label for="invitados"> <i class="fas fa-users"></i>
									Número de Invitados:
								</label> <input type="number" id="invitados" name="invitados"
									value="${pedido.invitados}" required min="1" max="20">
							</div>

							<div class="form_grupo">
								<label for="formaPago"> <i class="fas fa-credit-card"></i>
									Forma de Pago:
								</label> <select id="formaPago" name="formaPago" required>
									<option value="Efectivo"
										${pedido.formaPago == 'Efectivo' ? 'selected' : ''}>
										💵 Efectivo</option>
									<option value="Tarjeta"
										${pedido.formaPago == 'Tarjeta' ? 'selected' : ''}>
										💳 Tarjeta</option>
									<option value="Transferencia"
										${pedido.formaPago == 'Transferencia' ? 'selected' : ''}>
										🏦 Transferencia</option>
								</select>
							</div>

							<div class="form_grupo">
								<label for="nombreCliente"> <i class="fas fa-user"></i>
									Nombre del Cliente:
								</label> <input type="text" id="nombreCliente" name="nombreCliente"
					...
					<div class="seccion_formulario">
								...
								<div class="plato_card"
									...
									<div class="plato_imagen_container">
										<img
											...
											alt="${detalle.plato.nombrePlato}" class="plato_imagen">
									</div>

									<div class="plato_detalles">
										<h4 class="plato_nombre">${detalle.plato.nombrePlato}</h4>
										<p class="plato_precio">
											$
											<fmt:formatNumber value="${detalle.plato.precio}"
						...
						<div class="total_actualizable">
							<div class="total_info">
								<span class="total_label">Total del Pedido:</span> <span
									class="total_valor" id="totalPedido"> $<fmt:formatNumber
										value="${pedido.cantidadPagar}" minFractionDigits="2"
										maxFractionDigits="2" />
								</span>
							</div>
						</div>
