...
<body>
    <div class="contenedor_panel">
         <aside class="barra_lateral">
            ...
            <a href="" class="elemento_navegacion fa_navegacion_inactivo fa_tam">
                ...
                <c:forEach  var="plato" items="${platos}">
                    <div class="tarjeraPlato">
                        ...
                        <div class="nombrePrecio">
                            ...
                            <h3 class="color_naranja">
                                ${plato.precio}
                            </h3>
                        </div>
                        <div class="contenidoPlato">
                            <p class="color_gris"> ${plato.descripcion}</p>
                        </div>
                        <div class="notaBotton">
                            <div class="nota">
                                <i class="fa-solid fa-star color_naranja"></i>
                                <h3>${plato.valoracion}</h3>
                            </div>
